...
Internal TSEngine Core covers \hyperref[sec:renderer]{\ref*{sec:renderer} Renderer} and \hyperref[sec:headset]{\ref*{sec:headset} Headset with Controllers} abstraction, there is one place where these two things share the same encapsulation, this thing is \texttt{Context} class.\\
