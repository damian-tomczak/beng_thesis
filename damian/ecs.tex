...
Followed listening presents compile time oriented PBR Renderer Component. Materials' properties are based on article of Sébastien Lagarde "Feeding a physically based shading model"\cite{feedingpbr}. % TODO: link doesnt work
