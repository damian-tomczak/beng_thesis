...
\end{lstlisting}
Besides of all of it, Math library has a rotate function, but we didn't have an opportunity to use it in a \hyperref[sec:rotation_test]{non-testing environment}. Therefore, we won't elaborate about rotation. % TODO: dominik do you have time?
